...

{
	...
	public static class Login extends Navigation<WebContainer, LoginPage> 
	{
		@Override
		public LoginPage navigate(WebContainer WebContainer) throws Exception
		{
			String URL;
		...
		/*	public IMStage navigatetoIAMStage(WebContainer WebContainer) throws Exception
			{
				String URL;
				WebDriver driver = BrowserDriver.getCurrentDriver();
				readexcel excl= new readexcel();
